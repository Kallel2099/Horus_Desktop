...
public class ImpressEtiq extends javax.swing.JDialog {
    
    public static ImpressEtiq etiq;

    public ImpressEtiq(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        imprime();
        espera();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Imprimindo etiqueta.");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 40, 170, 40));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ImpressEtiq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImpressEtiq dialog = new ImpressEtiq(etiq, true);
