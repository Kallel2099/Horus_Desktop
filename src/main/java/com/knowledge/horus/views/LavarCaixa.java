...
public class LavarCaixa extends javax.swing.JDialog {
    ...
    public LavarCaixa(LeitorCódL parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        //JTable table = new JTable(lin, col) {
            ...
            jTextFieldDescCx = new javax.swing.JTextField();
            ...
            setLocation(new java.awt.Point(30, 130));
            setUndecorated(true);
            setResizable(false);
            ...
            jLabel5.setText("Conteúdo da caixa");
            ...
            jTextFieldCódCx.setBounds(80, 10, 230, 20);

            jLabel1.setText("Código");
            jPanel2.add(jLabel1);
            jLabel1.setBounds(10, 10, 60, 20);

            jTextFieldDescCx.setEnabled(false);
            jTextFieldDescCx.setFocusable(false);
            jPanel2.add(jTextFieldDescCx);
            jTextFieldDescCx.setBounds(80, 40, 230, 20);
            ...
            jLabel12.setBounds(10, 70, 60, 20);

            jTextFieldNomeCx.setEnabled(false);
            jTextFieldNomeCx.setFocusable(false);
            jPanel2.add(jTextFieldNomeCx);
            jTextFieldNomeCx.setBounds(80, 70, 230, 20);
    ...
    private void jTextFieldCódCxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldCódCxActionPerformed
        ...
        moviment.setPos(0);
        moviment.setQuery("SELECT * FROM movimentação WHERE codigo = '"+jTextFieldCódCx.getText().intern().trim()+"'");
        MovimentMod model = mov.Buscar2(moviment);
        if ((instru.getOk() == 1) && (caixa.getStatus() == 1)) {
            jTextFieldCódCx.setEnabled(!true);
            jTextFieldDescCx.setText(instrum.getDescrição().trim());
            jTextFieldNomeCx.setText(instrum.getFantasia());
            ...
            if (!model.getStatus().intern().trim().equalsIgnoreCase("Lavando")) {
                if (caixa.getStatus() == 1) {
                    ...
                    caixa.setCódCx(jTextFieldCódCx.getText());
                    CaixaMod modelcx = cxa.Buscar(caixa);
                    modelcx.setPos(1);
                    for (int i = 0; i < modelcx.getLin(); i++) {
                        modelcx = cxa.Buscar(caixa);
                        Object[] conteúdo = {modelcx.getCódInst(), modelcx.getDesInst()};
                ...
                JOptionPane.showMessageDialog(null, "<html><center>A caixa já foi recebida"
            ...
            JOptionPane.showMessageDialog(null, "<html><center>Comece identificando o"
                    + " código da caixa.<br>", "", JOptionPane.DEFAULT_OPTION);
            jTextFieldCódCx.setEnabled(true);
            jTextFieldCódCx.setText("");
            instrum.setOk(0);
        }
                ...
                if ((model.getStatus().intern().trim().equalsIgnoreCase("Danificado") && model.getAção() != null) 
                    ...
                    if (t2 == rows2 && t1 == rows1) {
                        JOptionPane.showMessageDialog(null, "<html><center>Este ítem não pertence"
                                + " a esta caixa!<br>", "", JOptionPane.DEFAULT_OPTION);
    ...
    private void jButtonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConcluirActionPerformed
        moviment.setCodigo(jTextFieldCódCx.getText());
        moviment.setDesc(jTextFieldDescCx.getText());
        moviment.setStatus("Lavando");
        moviment.setData(sdf.format(dt_atual));
        moviment.setPertence("Caixa");
        moviment.setFantasia(jTextFieldNomeCx.getText());
        ...
        for (int i = 0; i < Tabela1.getRowCount(); i++ ){
            ...
            moviment.setPertence(jTextFieldCódCx.getText());
            moviment.setFantasia(jTextFieldNomeCx.getText());
            moviment.setSetor(jTextFieldSetor.getText());
            moviment.setQtd(1);
            mov.Salvar(moviment);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(LavarCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LavarCaixa dialog = new LavarCaixa(lcaixa, true);
    ...
    private javax.swing.JTextField jTextFieldDescCx;
