...
public class LavarKit extends javax.swing.JDialog {
    ...
    public LavarKit(LeitorCódL parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        //JTable table = new JTable(lin, col) {
            ...
            jTextFieldDescKt = new javax.swing.JTextField();
            ...
            setMaximumSize(new java.awt.Dimension(920, 710));
            setMinimumSize(new java.awt.Dimension(920, 710));
            setUndecorated(true);
            ...
            jLabel5.setText("Conteúdo do kit");
            ...
            jTextFieldCódKt.setBounds(80, 10, 230, 20);

            jLabel1.setText("Código");
            jPanel2.add(jLabel1);
            jLabel1.setBounds(10, 10, 60, 20);

            jTextFieldDescKt.setEnabled(false);
            jTextFieldDescKt.setFocusable(false);
            jPanel2.add(jTextFieldDescKt);
            jTextFieldDescKt.setBounds(80, 40, 230, 20);
            ...
            jTextFieldNomeKt.setBounds(80, 70, 230, 20);
            ...
            jLabel11.setBounds(340, 10, 480, 20);
    ...
    private void jTextFieldCódKtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldCódKtActionPerformed
        ...
        kt.TestaKit(kit);
        moviment.setPos(0);
        moviment.setQuery("SELECT * FROM movimentação WHERE codigo = '"+jTextFieldCódKt.getText().intern().trim()+"'");
        MovimentMod model = mov.Buscar2(moviment);
        if ((instru.getOk() == 1) && (kit.getStatus() == 1)) {
            jTextFieldCódKt.setEnabled(!true);
            jTextFieldDescKt.setText(instrum.getDescrição().trim());
            jTextFieldNomeKt.setText(instrum.getFantasia());
            ...
            if (!model.getStatus().intern().trim().equalsIgnoreCase("Lavando")) {
                if (kit.getStatus() == 1) {
                    ...
                    kit.setCódKt(jTextFieldCódKt.getText());
                    KitMod modelkt = kt.Buscar(kit);
                    modelkt.setPos(1);
                    for (int i = 0; i < modelkt.getLin(); i++) {
                        modelkt = kt.Buscar(kit);
                        Object[] conteúdo = {modelkt.getCódInst(), modelkt.getDesInst()};
                ...
                JOptionPane.showMessageDialog(null, "<html><center>O kit já foi recebido"
            ...
            JOptionPane.showMessageDialog(null, "<html><center>Comece identificando o"
                    + " código do kit.<br>", "", JOptionPane.DEFAULT_OPTION);
            jTextFieldCódKt.setEnabled(true);
            jTextFieldCódKt.setText("");
            instrum.setOk(0);
        }
                ...
                if ((model.getStatus().intern().trim().equalsIgnoreCase("Danificado") && model.getAção() != null) 
                    ...
                    if (t2 == rows2 && t1 == rows1) {
                        JOptionPane.showMessageDialog(null, "<html><center>Este ítem não pertence"
                                + " a este kit!<br>", "", JOptionPane.DEFAULT_OPTION);
    ...
    private void jButtonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConcluirActionPerformed
        moviment.setCodigo(jTextFieldCódKt.getText());
        moviment.setDesc(jTextFieldDescKt.getText());
        moviment.setStatus("Lavando");
        moviment.setData(sdf.format(dt_atual));
        moviment.setPertence("Kit");
        moviment.setFantasia(jTextFieldNomeKt.getText());
        ...
        for (int i = 0; i < Tabela1.getRowCount(); i++ ){
            ...
            moviment.setPertence(jTextFieldCódKt.getText());
            moviment.setFantasia(jTextFieldNomeKt.getText());
            moviment.setSetor(jTextFieldSetor.getText());
            moviment.setQtd(1);
            mov.Salvar(moviment);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(LavarKit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LavarKit dialog = new LavarKit(lkit, true);
    ...
    private javax.swing.JTextField jTextFieldDescKt;
