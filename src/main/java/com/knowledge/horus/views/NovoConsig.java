...
public class NovoConsig extends javax.swing.JDialog {
    
    ComboBoxMod combo = new ComboBoxMod();
    ComboBoxSQL banc = new ComboBoxSQL();
    public static IdentificarConsig consig;
    public static LavarConsig cons;

    public NovoConsig(javax.swing.JDialog parent, boolean modal) {
        super (parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Novo Ítem");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NovoConsig.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NovoConsig dialog = new NovoConsig(consig, true);
