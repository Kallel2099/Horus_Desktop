...
public class NovoFornec extends javax.swing.JDialog {
    
    ComboBoxMod combo = new ComboBoxMod();
    ComboBoxSQL banc = new ComboBoxSQL();
    public static IdentificarConsig fornec;
    public static LavarConsig forn;

    public NovoFornec(javax.swing.JDialog parent, boolean modal) {
        super (parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 280, 110));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NovoFornec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NovoFornec dialog = new NovoFornec(fornec, true);
