...
public class NovoItem extends javax.swing.JDialog {
    
    ComboBox combo = new ComboBox();
    public static ArsenalView itens;

    public NovoItem(javax.swing.JDialog parent, boolean modal) {
        super (parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NovoItem dialog = new NovoItem(itens, true);
