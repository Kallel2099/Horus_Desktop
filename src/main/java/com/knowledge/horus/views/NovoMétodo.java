...
public class NovoMétodo extends javax.swing.JDialog {
    
    ComboBoxMod combo = new ComboBoxMod();
    ComboBoxSQL banc = new ComboBoxSQL();
    public static ReceberTextil met;

    public NovoMétodo(ReceberTextil parent, boolean modal) {
        super (parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Novo Método");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NovoMétodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NovoMétodo dialog = new NovoMétodo(met, true);
