...
public class NãoConforme extends javax.swing.JDialog {

    public static DescarregarAuto desc;
    DescarregarMod confor = new DescarregarMod();
    
    public NãoConforme(DescarregarAuto parent, boolean modal) {
        super (parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NãoConforme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NãoConforme dialog = new NãoConforme(desc, true);
