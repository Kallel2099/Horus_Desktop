...
public class PrepararCaixa extends javax.swing.JDialog {
    ...
    String valid = "";
    int v = 0;
    public static LeitorCódP pcaixa;
    ...
    public PrepararCaixa(LeitorCódP parent, boolean modal) {
        super (parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        //JTable table = new JTable(lin, col) {
            ...
            jLabel5.setBounds(340, 10, 620, 20);
            ...
            jTextFieldCódCx.setBounds(90, 10, 220, 20);

            jLabel1.setText("Código da caixa");
            jPanel2.add(jLabel1);
            ...
            jTextFieldNomeCx.setBounds(90, 40, 220, 20);

            jTextFieldEspeciali.setEnabled(false);
            jPanel2.add(jTextFieldEspeciali);
            jTextFieldEspeciali.setBounds(90, 70, 220, 20);
            ...
            jPanel2.add(jLabel4);
            jLabel4.setBounds(10, 40, 80, 20);

            jLabel8.setText("Setor");
            jPanel2.add(jLabel8);
            jLabel8.setBounds(10, 100, 40, 20);

            jTextFieldSetor.setEnabled(false);
            jPanel2.add(jTextFieldSetor);
            jTextFieldSetor.setBounds(90, 100, 220, 20);
            ...
            jLabel2.setText("Preparar caixa");
            ...
            jLabel11.setBounds(970, 10, 250, 20);
    ...
    private void jTextFieldCódCxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldCódCxActionPerformed
        ...
        moviment.setQuery("SELECT * FROM movimentação WHERE"
                + " codigo = '"+jTextFieldCódCx.getText().intern().trim()+"' AND status = 'Lavando' AND concluido IS NULL "
                + "OR codigo = '"+jTextFieldCódCx.getText().intern().trim()+"' AND status = 'Pendente' AND concluido IS NULL");
        ...
        if ((instru.getOk() == 1) && (caixa.getStatus() == 1)) {
            if (model.getStatus().intern().trim().equalsIgnoreCase("Lavando") 
                ...
                if (model.getStatus().intern().trim().equalsIgnoreCase("Pendente")) {
                    JOptionPane.showMessageDialog(null, "<html><center>Atenção!<br>"
                            ...
                            + "esta caixa encontra-se com alguma pendencia.", "", JOptionPane.DEFAULT_OPTION);
                }
                jTextFieldCódCx.setEnabled(!true);
                jTextFieldNomeCx.setText(instrum.getFantasia().trim());
                ...
                if (caixa.getStatus() == 1) {
                    ...
                    caixa.setCódCx(jTextFieldCódCx.getText());
                    CaixaMod modelbd = cxa.Buscar(caixa);
                    modelbd.setPos(1);
                    for (int i = 0; i < modelbd.getLin(); i++) {
                        modelbd = cxa.Buscar(caixa);
                ...
                JOptionPane.showMessageDialog(null, "<html><center>A caixa não passou"
            ...
            JOptionPane.showMessageDialog(null, "<html><center>Comece identificando o código"
                    + " da caixa.<br>", "", JOptionPane.DEFAULT_OPTION);
            jTextFieldCódCx.setEnabled(true);
            jTextFieldCódCx.setText("");
            jTextFieldCódCx.requestFocus();
            instrum.setOk(0);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(PrepararCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrepararCaixa dialog = new PrepararCaixa(pcaixa, true);
