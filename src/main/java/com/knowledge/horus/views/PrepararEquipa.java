...
public class PrepararEquipa extends javax.swing.JDialog {
    ...
    int e = 0;
    int l = 0;
    public static LeitorCódP pequipa;
    ...
    public PrepararEquipa(LeitorCódP parent, boolean modal) {
        super (parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Preparar equipamento");
        ...
        jLabel1.setBounds(260, 570, 50, 20);
        ...
        if (instrum.getOk() == 1) {
            if (instrum.getItem().intern().trim().equalsIgnoreCase("Equipamento")) {
                if (model.getStatus().intern().trim().equalsIgnoreCase("Lavando")) {
                    ...
                    if (Tabela.getRowCount() == 0) {
                        ...
                        for (int i = 0; i < Tabela.getRowCount(); i++) {
                            if (jTextFieldCód.getText().intern().trim().equals(((String) jTable.getValueAt(i, 0)).intern().trim())
                                    && (jTable.getValueAt(i, 3).equals("Preparando"))){
                                e = 1;
                    ...
                    JOptionPane.showMessageDialog(null, "<html><center>Atenção!<br>"
                            + "Consta no sistema a informação de que <br>"
                            + "o equipamento já foi preparado!<br>", "", JOptionPane.DEFAULT_OPTION);
                    jTextFieldCód.setText("");
                    jTextFieldCód.requestFocus();
                } else {
                    JOptionPane.showMessageDialog(null, "<html><center>Atenção!<br>"
                            + "O equipamento não passou pela lavagem!<br>", "", JOptionPane.DEFAULT_OPTION);
                    jTextFieldCód.setText("");
                    jTextFieldCód.requestFocus();
                }
            } else {
                JOptionPane.showMessageDialog(null, "<html><center>Atenção!<br>O código não pertence"
                        + " a um equipamento!<br>", "", JOptionPane.DEFAULT_OPTION);
                jTextFieldCód.setText("");
                jTextFieldCód.requestFocus();
            }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(PrepararEquipa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrepararEquipa dialog = new PrepararEquipa(pequipa, true);
